...
<script>
    function jobsMenuData() {
      ...
      <div class="col-lg-8">
        <div class="card shadow-sm" >
          <div class="card-header bg-transparent border-0">
            <h3 class="mb-0"><i class="fa fa-phone-square"></i>&nbsp;ASTERISC INTERNSHIP</h3>
...
$sql = "SELECT * FROM  asterisc_internship";
                                    ...
                                    <tr>
                                        <td class="resultContent">
                                            <div class="css-1m4cuuf e37uo190">
                                                <h2 class="jobTitle jobTitle-newJob css-bdjp2m eu4oa1w0" tabindex="-1">
                                                    <a id="job_e79ef11e07e399ed" data-mobtk="1gp08q9hdjkbn800" data-jk="e79ef11e07e399ed" data-hiring-event="false" target="_blank" data-hide-spinner="true" role="button" aria-label="full details of Call Centre Agent" class="jcs-JobTitle css-jspxzf eu4oa1w0" href="/company/Hotel-Ashoka/jobs/Call-Centre-Agent-e79ef11e07e399ed?fccid=a24e67fa8e935553&amp;vjs=3">
                                                        <h2><a href="#"><span title="Call Centre Agent" id="jobTitle-e79ef11e07e399ed"><?= $row['name'] ?></span></a></h2>
                                                    </a>
                                                </h2>
                                            ...
                                            <div class="heading6 company_location tapItem-gutter companyInfo">
                                                <span class="companyName"><?= $row['job_title'] ?></span>
                                                <div class="companyLocation"><?= $row['location'] ?></div>
                                            </div>
                                            <div class="heading6 tapItem-gutter metadataContainer noJEMChips salaryOnly">
                                                <div class="metadata salary-snippet-container">
                                                    <div class="attribute_snippet" data-testid="attribute_snippet_testid"><?= $row['salary_range'] ?> a month</div>
                                                </div>
                                                <div class="metadata">
                                                ...
                                                <div class="metadata">
                                                    <div class="attribute_snippet" data-testid="attribute_snippet_testid">
                                                        ...
                                                        </svg> &nbsp;<?= $row['work_of_hour'] ?> hours
                                                    </div>
                                                </div>
                                                <a href="internship.php" class="btn btn-light "><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-briefcase" viewBox="0 0 16 16">
