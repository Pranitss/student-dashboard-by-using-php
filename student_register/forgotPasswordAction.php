...
{
require ('D:/xampp/htdocs/student_dashboard/student_register/mail/PHPMailer/src/Exception.php'); // Include the PHPMailer library
require ('D:/xampp/htdocs/student_dashboard/student_register/mail/PHPMailer/src/PHPMailer.php'); 
require ('D:/xampp/htdocs/student_dashboard/student_register/mail/PHPMailer/src/SMTP.php');
	$mail = new PHPMailer(); 
    try
    {
	$mail->IsSMTP(); 
    ...
    <a href='http://localhost/student_dashboard/student_register/updatepassword.php?email=$email&reset_token=$reset_token'>Reset Password </a>";
...
if (isset($_POST['reset_password'])) {
    // Assuming you have established a database conection as $con
    ...
    if ($result) {
        if (mysqli_num_rows($result) == 1) {
            ...
            if (mysqli_query($con, $query) && sendMail($_POST['email'],$reset_token)) {
                ...
                window.location.href='/student_dashboard/student_register/login.php';
                </script>";
            } else {
                echo "<script>
