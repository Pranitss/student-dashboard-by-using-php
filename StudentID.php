...
if(isset($Email)){
  ...
  $student_number = $rt['student_number'];
  //$address = $rt['address'];
...
<script>
    function jobsMenuData() {
      ...
      <div class="col-lg-8">
        ...
        <div class="card shadow-sm">
          <div class="card-header bg-transparent border-0">
            <h3 class="mb-0"><i class="fa fa-download "></i> STUDENT ID CARD</h3>
          </div>
  ...
  <div class="col-lg-6">
    <div class="card border border-dark"> <!-- Add a border to mimic an ID card -->
      <div class="card-header bg-transparent text-center">
        <img class="profile_img img-fluid" src="stuimg/<?php echo $dp ?>" alt="student dp">
        <h2 class="mb-0"><?php echo $fname ?></h2>
      </div>
      <div class="card-body">
        <p class="mb-0"><strong>PRN ID:</strong> <?php echo $stdid ?></p>
        <p class="mb-0"><strong>Course:</strong> <?php echo $cname ?></p>
        <p class="mb-0"><strong>Date of Birth:</strong> <?php echo $dob ?></p>
        <p class="mb-0"><strong>Batch Timing:</strong> <?php echo $batchtm ?></p>
        <p class="mb-0"><strong>Student Phone Number:</strong> <?php echo $student_number ?></p>
        <p class="mb-0"><strong>Email:</strong> <?php echo $email ?></p>
      </div>
      <div class="card-footer bg-transparent text-center">
        <small>This card is for class official use only.</small>
      </div>
    </div>
  </div>
</div>
    ...
    <?php
			...
			$i = 1;
			$rows = mysqli_query($con, "SELECT * FROM student_admission where email='".$mb."'");
