...
<script>
    function jobsMenuData() {
      ...
      <div class="col-lg-8">
        ...
        <div class="card shadow-sm">
          <div class="card-header bg-transparent border-0">
            <h3 class="mb-0"><i class="fa fa-download "></i> Downloads Data</h3>
          </div>
          <div class="card-body pt-0" style ="overflow:auto">
            ...
            <table class="table table-bordered">
              ...
              <!-- <th style="color: white;">Remark</th> -->
                <th style="color: white;">Downlode</th>
              </tr>
    ...
    <?php
            ...
            $rows = mysqli_query($con, "SELECT * FROM downlode ");
              ...
              <tr>
                    ...
                    if($remark=='Pending'){
                      echo "<td>-</td>";
                       ...
                       echo "<td><a href= '".$row['downlode']."' target='_blank' >Download</a></td>";
                      }
